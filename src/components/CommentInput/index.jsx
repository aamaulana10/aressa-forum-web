        ...
        <div className="mb-6">
            <div className="bg-white rounded-lg border border-gray-100 p-4">
                ...
                <div className="flex justify-end">
                    <button
                        className="px-4 py-2 bg-[#7857ED] text-white rounded-lg hover:bg-[#6745D8] transition-all duration-200 flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                        onClick={onSubmit}
